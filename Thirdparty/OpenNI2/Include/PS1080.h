...
enum
{
	...
	XN_MODULE_PROPERTY_QN_INFO,
	XN_MODULE_PROPERTY_QN_VERIFY,
        //mx6300 version
        XN_MODULE_PROPERTY_VERSION_MX6300,
        //rgb resolution for d2c
        XN_MODULE_PROPERTY_D2C_RESOLUTION,
	XN_MODULE_PROPERTY_USB_SPEED,
        XN_MODULE_PROPERTY_PRODUCT_SERIAL_NUMBER,//product write sn(S1/T1)

	//ir flood level
	XN_MODULE_PROPERTY_IRFLOOD_LEVEL,
	XN_MODULE_PROPERTY_PRODUCT_NUMBER,

	//Auto AE
	XN_MODULE_PROPERTY_AE,
	//u1
	XN_MODULE_PROPERTY_MIPI_TEST,
	/*******************************************************************/
